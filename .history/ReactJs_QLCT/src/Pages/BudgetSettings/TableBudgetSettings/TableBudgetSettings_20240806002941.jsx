...
// Xóa ngân sách dựa trên id và cập nhật danh sách ngân sách sau khi xóa
const handleDelete = async (id) => {
        try { 
            //gọi hàm deleteJobs để xóa dữ liệu thông qua id và cập nhập dữ liệu jobs để cập nhập jobs lại sau khi dữ liệu bị xóa 
