        ...
        <div className="w-full h-screen flex justify-center items-center">
            <div className="w-2/5 h-screen flex justify-center">
                <div className="flex-col flex justify-center">
                    ...
                    {/* <ItemInput type='button' placeholder='' value='Register'/> */}
                    <button onClick={addUser}
                    className='bg-[#308BEB] text-white font-bold border-2 rounded-lg w-80 px-4 py-3'>Register</button>
                    <span className="text-sm flex justify-center ">
                        Have already an account?{' '}
                        <Link to="/login" className="text-[#308BEB]">
                            {' '}
                            Login{' '}
                        </Link>
                    </span>
